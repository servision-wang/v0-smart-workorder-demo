  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex items-center px-4 py-3 border-b border-border bg-card">
        ...
        <h1 className="flex-1 text-center font-semibold text-foreground tracking-tight">EPC Parts Catalogue</h1>
        <div className="w-9" />
      </div>
      ...
      <div className="px-4 py-2 bg-card/50 border-b border-border overflow-x-auto">
        <div className="flex items-center gap-1 text-xs text-muted-foreground whitespace-nowrap">
          ...
          <span>2018</span>
          <ChevronDown className="w-3 h-3 rotate-[-90deg]" />
          <span className="text-primary font-medium">Engine Block</span>
        </div>
      </div>
      ...
      <div className="px-4 py-3 bg-card border-b border-border space-y-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-muted-foreground">
            Total <span className="text-primary font-medium">{filteredParts.length}</span> items
          </span>
        </div>
      </div>
      ...
      <div className="border-b border-border bg-card/30">
        <div className="px-4 py-2 flex items-center justify-between">
          <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Exploded View</span>
        ...
        <div className="h-40 mx-4 mb-3 bg-secondary/50 rounded-xl border border-border flex items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <span className="mt-2 text-xs text-muted-foreground">Engine Block Assembly</span>
            <span className="text-[10px] text-muted-foreground/60">Click part number to view location</span>
          </div>
          {/* Callout markers */}
      ...
      <div className="px-4 py-4 border-t border-border bg-card">
        {selectedEpcPartId ? (
          ...
          <p className="text-center text-xs text-muted-foreground mb-3">Please select a part from the list</p>
        )}
        <Button
      ...
      <FloatingVoiceButton
        hints={['Select first', 'Select piston', 'Select rod', 'Confirm', 'Back']}
      />
    </div>
  )
}
